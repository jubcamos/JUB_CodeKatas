...
namespace EfCoreResult.Migrations
{
    ...
    [Migration("20231106113448_ManyToMany2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EfCoreResult.Models.Partnership", b =>
                {
                    ...
                    b.HasKey("PublisherId", "DeveloperStudioId");
            ...
            modelBuilder.Entity("EfCoreResult.Models.Publisher", b =>
                {
                    ...
                    b.Property<int>("CustomerDeveloperStudioId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CustomerDeveloperStudioId");
            ...
            modelBuilder.Entity("EfCoreResult.Models.Publisher", b =>
                {
                    b.HasOne("EfCoreResults.Models.DeveloperStudio", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerDeveloperStudioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
